...
public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    [SerializeField]
    private float _moveX = 3;

    #endregion
    #region Reference (Reference Variables)
    ...
    {
        HandlerRange = _handlerRange;
        DeadZone = _deadZone;
        _baseRect = GetComponent<RectTransform>();
        _canvas = GetComponentInParent<Canvas>();
        if(_canvas == null)
        {
            Debug.Log("This script goes on a child in the Canvas... NOT ON THE CAMERA!");
        }
        Vector2 center = new Vector2(00.5f, 0.5f);
